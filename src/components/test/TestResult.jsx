...
export default function TestResult() {
  ...
  const handleShowResultsList = () => navigate('/resultlist');
  if (!currentResult) return <p>결과를 확인할 수 없습니다. 테스트를 다시 시도해 주세요.</p>;
  ...
  return (
    <Article className="flex items-center justify-center w-full p-8 ex-col TestResult ">
      ...
      <div className="result">
        <div className="w-1/3 mx-auto my-8 -z-10 -top-20 -right-12 opacity-85"></div>
